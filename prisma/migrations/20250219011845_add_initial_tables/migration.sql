-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'IN_PREPARSTION', 'FINISHED');
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_retaurantId_fkey" FOREIGN KEY ("retaurantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

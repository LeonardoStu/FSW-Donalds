...
-- DropForeignKey
ALTER TABLE "Order" DROP CONSTRAINT "Order_retaurantId_fkey";
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_retaurantId_fkey" FOREIGN KEY ("retaurantId") REFERENCES "Restaurant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
